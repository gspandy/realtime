...
public class BiLogSplittingBolt extends BaseRichBolt {
	...
	private static final Logger logger = LoggerFactory.getLogger(BiLogSplittingBolt.class);
	 ...
	 */
	@Override
	public void declareOutputFields(OutputFieldsDeclarer declarer) {//根据action字段发射
